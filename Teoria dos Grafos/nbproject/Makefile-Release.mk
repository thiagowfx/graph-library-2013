...
${OBJECTDIR}/GraphAlgorithms.o: GraphAlgorithms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GraphAlgorithms.o GraphAlgorithms.cpp
...
${TESTDIR}/tests/dfs_testclass.o: tests/dfs_testclass.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/dfs_testclass.o tests/dfs_testclass.cpp


${TESTDIR}/tests/dfs_testrunner.o: tests/dfs_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/dfs_testrunner.o tests/dfs_testrunner.cpp
...
${OBJECTDIR}/GraphAlgorithms_nomain.o: ${OBJECTDIR}/GraphAlgorithms.o GraphAlgorithms.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/GraphAlgorithms_nomain.o GraphAlgorithms.cpp;\
	else  \
